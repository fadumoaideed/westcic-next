...
export default function StatsGridWithImage() {
   return (
      <Box bg={'teal.800'} position={'relative'}>
         <Flex
            flex={1}
            zIndex={0}
            display={{ base: 'none', lg: 'flex' }}
            backgroundImage="url('https://res.cloudinary.com/westcic/image/upload/v1640045439/lab_sww3q6.jpg')"
         ...
         >
            <Flex
               bgGradient={'linear(to-r, teal.800 10%, transparent)'}
               w={'full'}
               h={'full'}
            />
         </Flex>
               ...
               >
                  <Box mb={{ base: 8, md: 20 }}>
                     ...
                     <Text fontSize={'xl'} color={'gray.400'}>
                        The NewLife™ technology allows you to monitor your crops
...
const stats = [
   ...
   },
   {
      ...
      content: (
         <>
            <StatsText>Plants</StatsText> currently connected and monitored by
            the NewLife™ software
         </>
      )
   }
]
